        ...
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                <div className={cx('logo')}>
                    <a href="https://everon.com/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className={cx('form-desktop')}>
                        ...
                        <div className={cx('email')}>
                            <span className={cx('title')}>Đừng bỏ lỡ khuyến mại hấp dẫn từ Everon!</span>
                    ...
                    <div className={cx('right')}>
                        ...
                        <ul>
                            <li>
                                ...
                                <span>Cụm dân cư Nội Thương, xã Dương Xá, huyện Gia Lâm, Hà Nội</span>
                            </li>
                            <li>
                                <img src={hotlineIcon} alt="Hotline" />
